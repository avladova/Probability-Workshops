...
#And the last for this work, I want to put a trend line on every scatteк plot, I already did it, when was introducing the correlation of tickers.
#Thank you for getting familiar with my work.
